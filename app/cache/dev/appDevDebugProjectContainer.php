...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'expert', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Expert\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Expert\\AdministrationBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Expert\\UserBundle\\Entity');
        $c->addDriver($b, 'Expert\\AdministrationBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('ExpertUserBundle' => 'Expert\\UserBundle\\Entity', 'ExpertAdministrationBundle' => 'Expert\\AdministrationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a38fb0733ae17f170a7d3f0e31e3f6b04c0ffc68a1de7866be493a4e11486278');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Expert\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Expert\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Expert\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Expert\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Expert\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $g = new \Symfony\Component\HttpFoundation\RequestMatcher('^/acceuil');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Expert\\UserBundle/Resources/views'), 'ExpertUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Expert\\AcceuilBundle/Resources/views'), 'ExpertAcceuil');
        $instance->addPath(($this->targetDirs[3].'\\src\\Expert\\AdministrationBundle/Resources/views'), 'ExpertAdministration');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ExpertUserBundle' => 'Expert\\UserBundle\\ExpertUserBundle',
                'ExpertAcceuilBundle' => 'Expert\\AcceuilBundle\\ExpertAcceuilBundle',
                'ExpertAdministrationBundle' => 'Expert\\AdministrationBundle\\ExpertAdministrationBundle',
            ...
            'fos_user.model.user.class' => 'Expert\\UserBundle\\Entity\\User',
